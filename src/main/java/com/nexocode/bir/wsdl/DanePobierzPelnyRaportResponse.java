...
public class DanePobierzPelnyRaportResponse {
    ...
    @XmlElement(name = "DanePobierzPelnyRaportResult", nillable = true)
    protected String danePobierzPelnyRaportResult;
     ...
     *     
     */
    public String getDanePobierzPelnyRaportResult() {
     ...
     *     
     */
    public void setDanePobierzPelnyRaportResult(String value) {
